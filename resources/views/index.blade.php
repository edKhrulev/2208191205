            ...
            <header>
                <div class="center_box">
                    <div class="wrapper">
                        ...
                        <div class="logo_box">
                            <a href="{{url("/")}}"><img src="img/logo.png" alt="foodclub" /></a>
                        </div>
                            ...
                            <div class="uofb cf">
                                <div class="l_col adrs">
                                    ...
                                    <form action="/" method="post">
                                        ...
                                        <div class="field">
                                            ...
                                            <input type="text" name="city" value="" palceholder="" class="vl_empty" />
                                        </div>
                                        <div class="field">
                                            <label>Your area *</label>
                                            <input type="text" name="area" value="" palceholder="" class="vl_empty" />
                                        </div>
                                ...
                                <div class="r_col">
                                    ...
                                    <div class="uo_adr_list">
                                        ...
                                        <div class="item">
                                            <h3>HOME Address</h3>
                                            <p>{{$address->city}}, {{$address->area}}, {{$address->street}}<br/>{{$address->additional_info}}, {{$address->house}}</p>
                                            <div class="actbox">
